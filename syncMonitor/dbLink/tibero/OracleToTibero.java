package syncMonitor.dbLink.tibero;
...
public class OracleToTibero implements Dblink {
    ...
    public OracleToTibero(String oracleDbLinkName, String sourceName, String targetName ,Connection connection) {
